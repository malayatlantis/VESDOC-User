...
function Footer(props) {
    ...
    return (
        <>
        <footer className="footer desktopFooter">
        <div className="container">
            <div className="row">
                <div className="col-12 col-sm-8 col-md-6 col-lg-4 col-xl-3 order-4 order-md-1 order-lg-4 order-xl-1">
                    ...
                    VESDOC - Watch Web Series, Movies,<br/> Documentary Online.
                    </p><br/>
                    <div className="footer__social">
                        <a href="#" target="_blank">
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M0 15C0 6.71573 6.71573 0 15 0C23.2843 0 30 6.71573 30 15C30 23.2843 23.2843 30 15 30C6.71573 30 0 23.2843 0 15Z" fill="#3B5998"></path>
                                <path
                        ...
                        <a href="#" target="_blank">
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M0 15C0 6.71573 6.71573 0 15 0C23.2843 0 30 6.71573 30 15C30 23.2843 23.2843 30 15 30C6.71573 30 0 23.2843 0 15Z" fill="#55ACEE"></path>
                                <path
                        ...
                        <a href="../../../accounts/login/index.htm" target="_blank">
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M0 15C0 6.71573 6.71573 0 15 0C23.2843 0 30 6.71573 30 15C30 23.2843 23.2843 30 15 30C6.71573 30 0 23.2843 0 15Z" fill="white"></path>
                                <mask id="mask0" maskUnits="userSpaceOnUse" x="0" y="0" width="30" height="30">
                                    <path fillRule="evenodd" clipRule="evenodd" d="M0 15C0 6.71573 6.71573 0 15 0C23.2843 0 30 6.71573 30 15C30 23.2843 23.2843 30 15 30C6.71573 30 0 23.2843 0 15Z" fill="white"></path>
                                </mask>
                                <g mask="url(#mask0)">
                                    <path
                                        fillRule="evenodd"
                        ...
                        <a href="#" target="_blank">
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M0 15C0 6.71573 6.71573 0 15 0C23.2843 0 30 6.71573 30 15C30 23.2843 23.2843 30 15 30C6.71573 30 0 23.2843 0 15Z" fill="#4C6C91"></path>
                                <path
                        ...
                        <a href="#" target="_blank">
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M0 15C0 6.71573 6.71573 0 15 0C23.2843 0 30 6.71573 30 15C30 23.2843 23.2843 30 15 30C6.71573 30 0 23.2843 0 15Z" fill="#010101"></path>
                                <path
                                ...
                                <path
                                    ...
                                    fill="#25F4EE"
                                ></path>
                                <path d="M22.1125 10.8133V10.1489C21.3087 10.1491 20.5227 9.91193 19.8533 9.46704C20.4401 10.1493 21.2332 10.6219 22.1125 10.8133Z" fill="#25F4EE"></path>
                                <path d="M19.8534 9.46693C19.1939 8.71597 18.8304 7.75063 18.8306 6.75122H18.0333C18.2414 7.86795 18.8996 8.84996 19.8534 9.46693Z" fill="#FE2C55"></path>
                                <path
                ...
                <div className="col-12 col-md-8 col-lg-6 col-xl-4 order-3 order-lg-2 order-md-3 order-xl-3">
                    <div className="row">
                        <div className="col-12">
                            <h6 className="footer__title">About VESDOC</h6>
                        </div>

                        <div className="col-12" style={{color:"white"}}>
                        <p>VESDOCis an online video streaming platform owned by Novi Digital Entertainment Private Limited, a wholly owned subsidiary of Star India Private Limited. currently offers over 100,000 hours...<Link to='/about'>Show more</Link></p>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-12 col-md-8 col-lg-6 col-xl-4 order-3 order-lg-2 order-md-3 order-xl-3">
                    <div className="row">
                        ...
                        <div className="col-6">
                            <div className="footer__nav">
                                <Link to="/about">About VESDOC</Link>
            ...
            <div className="row">
                <div className="col-12">
                    <div className="footer__content">
                        ...
                        <small className="footer__copyright">© 2021 VESDOC. All Rights Reserved. Design and Developed by <a href="https://quantex.co.in" target="_blank">Quantex Consulting Services PVT. LTD.</a></small>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div className=" extraFooter">
        <center style={{color:"white"}}>
            © 2021 VESDOC. All Rights Reserved.
        </center> 
        <center style={{color:"white",fontSize:"11p.5x"}}>
            Design and Developed by Quantex Consulting Services PVT. LTD.
        </center>
    </div>
    </>
    )
